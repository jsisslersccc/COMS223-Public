...
/**
 * This class implements a low-level binary tree structure that can be accessed
 * and manipulated via its nodes and its links. The structure is represented in
 * a recursive fashion, i.e. an instance of this class is really a node object
...
public class BinaryTree<T> {
	...
	/**
	 * Empties this tree by removing all nodes including root. To start over, the
	 * makeRoot method must be called.
	 */
	public void clear() {
		left = null;
		right = null;
