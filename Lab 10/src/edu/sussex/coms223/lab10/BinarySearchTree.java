...
/**
 * This class implements a simple (not balanced) generic binary search tree.
...
public class BinarySearchTree<T extends Comparable<T>> {
	 ...
	 * @return The binary (search) tree node whose data matches the key, null if no
	 *         match is found for the key in the tree.
	 */
	 ...
	 * 
	 * @param key Key that is searched for.
	 * @return Data entry in this BST that matches the given key, null if no match
	 *         is found for the key in this BST.
	 */
	 ...
	 * @throws OrderViolationException If there is already a key in this BST that
	 *                                 matches this item, i.e. inserting would
	 ...
	 * 
	 * @param deleteNode Node whose parent will receive new node as right or left
	 *                   child, depending on whether this node is its parent's right
	 *                   or left child.
	...
	/**
	 * Deletes from this BST the item that matches the given key,and returns the
	 * item.
	 * 
	 * @param key Key of to-be-deleted item.
	 * @return The deleted item.
	 * @throws NoSuchElementException If there is no item in this BST that matches
	 *                                the given key.
	 */
	...
	/**
	 * Implements a recursive preorder traversal on a binary (search) tree given its
	 * root, calling the given visitor's visit method when a node is visited.
	 * 
	 * @param root    Root of binary (search) tree on which preorder traversal is
	 *                performed.
	 * @param visitor Visitor instance in which client-specific visit action is
	 *                defined.
	 */
	...
	/**
	 * Implements a preorder traversal on this BST, calling the given visitor's
	 * visit method when a node is visited.
	 * 
	 * @param visitor Visitor instance in which client-specific visit action is
	 *                defined.
	 */
	...
	/**
	 * Implements a recursive inorder traversal on a binary (search) tree given its
	 * root, calling the given visitor's visit method when a node is visited.
	 * 
	 * @param root    Root of binary (search) tree on which inorder traversal is
	 *                performed.
	 * @param visitor Visitor instance in which client-specific visit action is
	 *                defined.
	 */
	...
	/**
	 * Implements an inorder traversal on this BST, calling the given visitor's
	 * visit method when a node is visited.
	 * 
	 * @param visitor Visitor instance in which client-specific visit action is
	 *                defined.
	 ...
	 * 
	 * @param root    Root of binary (search) tree on which postorder traversal is
	 *                performed.
	 * @param visitor Visitor instance in which client-specific visit action is
	 *                defined.
	 */
	...
	/**
	 * Implements a postorder traversal on this BST, calling the given visitor's
	 * visit method when a node is visited.
	 * 
	 * @param visitor Visitor instance in which client-specific visit action is
	 *                defined.
	...
	// TODO 1: Implement findNode
	public BinaryTree<T> findNode(T val) {
		return null;
	}

	// TODO 2: Implement depth
