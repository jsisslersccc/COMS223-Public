...
public class BinaryTreeDriver {
	 ...
	 */
	static final BufferedReader stdbr = new BufferedReader(new InputStreamReader(System.in));
	...
	/**
	 * Binary tree that can hold String data - used as temporary variable to create
	 * nodes to attach to main tree, myTree.
	 */
	 ...
	 */
	static Action getAction() throws IOException {
		int tries = 3;
		while (tries > 0) {
			System.out.println();
	 ...
	 */
	static void firstCreate() throws IOException {
	 ...
	 * @throws TreeViolationException If myTree already has a child on the side
	 *                                where attachment is attempted.
	 */
	 ...
	 */
	static void detach() throws IOException {
		System.out.print("Left (0) or Right (1)? ==> ");
		System.out.flush();
		int index = Integer.parseInt(stdbr.readLine());
	...
	static void move() throws IOException {
		System.out.print("Which direction? 0/1/2/3 for " + "Root/leftchild/rightchild/parent => ");
		System.out.flush();
		int index = Integer.parseInt(stdbr.readLine());
		switch (index) {
		case 0:
	...
	/**
	 * Performs a preorder traversal of a given binary tree, and prints data stored
	 * at each node.
	 * 
	...
	/**
	 * Performs an inorder traversal of a given binary tree, and prints data stored
	 * at each node.
	 * 
	 * @param root Root of the binary tree that is to be traversed.
	 */
	...
	/**
	 * Performs a non-recursive inorder traversal of a given binary tree. When a
	 * node is visited, calls the visit method of the Visitor instance, to take
	...
	/**
	 * Performs a postorder traversal of a given binary tree, and prints data stored
	 * at each node.
	 * 
	 * @param root Root of the binary tree that is to be traversed.
	 */
	 ...
	 */
	public static void main(String[] args) throws IOException, TreeViolationException {
