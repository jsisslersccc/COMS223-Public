...
/**
 * This class implements a stack that is used to evaluate an expression, and
 * stores floating point numbers. It is only visible in its package.
 * 
...
class StackKeeper {
	...
	/**
	 * The evaluation stack that keeps operands and results of evaluating
	 * sub-expressions.
	 */
	Stack<Float> evalStack;

	/**
	 * Initializes a new instance by creating an empty evaluation stack of floating
	 * point numbers.
	 */
	StackKeeper() {
	...
	/**
	 * Updates the evaluation process with a given token. If the token is an
	 * operand, it is pushed on the evaluation stack. If it is an operator, an
	 * evaluation is done with the operator.
	 * 
